<%-- 
    ...
    Created on : 17/08/2020, 04:14:15 PM
    Author     : Usuario
--%>
...
<html>
    ...
    <body>
        <div class="container">
            <form name="AgregarAreaForm" action="ControladorArea" method="get">
                <table  class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                <input class="btn-primary" type="submit" value="Agregar Area" name="agregar" />
                                <input type="hidden" value="agregararea02" name="f_accion"/>
