...
<html>
    ...
    <body>
        <div class="container">
            <form name="AgregarRolForm" action="ControladorRol" method="get">
                <table  class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                <input class="btn-primary" type="submit" value="Agregar Rol" name="agregar" />
                                <input type="hidden" value="agregarrol02" name="f_accion"/>
